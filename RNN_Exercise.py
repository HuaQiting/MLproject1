...
class ExerciseEEGSimpleRNN(nn.Module):
    ...
    def clip_gradients(self):
        ...
        return nn.utils.clip_grad_norm_(self.parameters(), self.grad_clip)  # TODO-RNN-6: 使用 clip_grad_norm_ 裁剪 self.parameters()
...
class ExerciseEEGLSTM(nn.Module):
    ...
    def clip_gradients(self):
        # 梯度爆炸处理（训练侧）：backward 后执行
        return nn.utils.clip_grad_norm_(self.parameters(), self.grad_clip)  # TODO-6: 使用 clip_grad_norm_ 裁剪 self.parameters()
